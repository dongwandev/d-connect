 ...
 * 우측: 페이지 액션 · 알림 벨 · 도움말 · 사용자 드롭다운
 *
 * 알림/도움말은 프로토타입 단계 — 클릭 시 '준비 중' 토스트로 안내한다.
    ...
    <header className="sticky top-0 z-20 flex min-h-16 items-center justify-between gap-3 border-b border-border bg-surface py-2.5 pl-16 pr-3 md:px-6">
      ...
      <div className="flex shrink-0 items-center gap-1.5">
        ...
        <button
          ...
          aria-label="알림"
          className="rounded-full p-2 text-gray-500 transition-colors hover:bg-surface-muted hover:text-gray-800 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent-500"
        >
